...
class HCRNNetworkBert(nn.Module):
    def __init__(self, vision_dim, module_dim, k_max_frame_level, k_max_clip_level, spl_resolution, vocab, question_type, transformer_cache_dir=None, transformer_path = 'bert-base-uncased', train_bert = False, mult_embedding=False):
